// CSR + Hydration — client component that receives SSR-prefetched data as initialData
// React Query takes over after hydration for real-time updates
'use client';
...
export default function DashboardClient({ initialUser, initialEnrollments }: DashboardClientProps) {
  // Hydration: React Query is seeded with SSR data; subsequent updates come from the client
  const { data: enrollments, isLoading } = useEnrollments(initialEnrollments);
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-2 space-y-1">
                            <div className="flex justify-between text-xs text-muted-foreground">
                              ...
                              <span>
                                {Math.round(
                                  (enrollment.course.totalLessons * enrollment.progress) / 100,
                                )}
